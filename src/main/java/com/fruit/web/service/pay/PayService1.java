...
public class PayService1 {
    ...
    public static final Logger log = Logger.getLogger(PayService1.class.toString());
    /**
     * 微信统一支付接口
     */
     ...
     * 微信jsAPI(公众号)支付
     */
    public String wechatJspaiPayTest(String out_trade_no, BigDecimal total_fee) {
        WeChatPayConfig weChatPayConfig = new WeChatPayConfig(out_trade_no, total_fee.setScale(2,BigDecimal.ROUND_UP).longValue());
        return null;
    }
...
//        String prepay_id = new PayService1().wechatJsApiPay("JSAPI支付测试", "1415659990", 1);
//        System.out.println(prepay_id);
        BigDecimal bigDecimal = new BigDecimal(12.555);
        BigDecimal bigDecimal1 = bigDecimal.setScale(2, BigDecimal.ROUND_HALF_UP);
        System.out.println(bigDecimal1.longValue());
        System.out.println(bigDecimal1.longValueExact());
    }
